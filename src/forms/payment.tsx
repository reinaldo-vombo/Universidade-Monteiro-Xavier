...
import { paymentZodSchema } from '../lib/validation/payment'
...
export default function PaymentForm({ studentId, paymentId }: TProps) {
   ...
   async function onSubmit(values: z.infer<typeof paymentZodSchema>) {
      ...
      try {
         ...
         formData.append("candidateId", values.studentId);
         ...
         const url = `${clientEnv.GATSBY_API_BASE_URL}/payments/invoice/${paymentId}/student/${studentId}`;
